    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <header className="bg-[#1b3a3a] text-white py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 z-50 shadow-md">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
           ...
           <button onClick={() => navigate('/PublicServiceBooking')} className="text-[#3a9e9e] font-bold hover:text-white transition-colors">Boka Service</button>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-[#1b3a3a] pt-[88px] px-6 flex flex-col gap-6 text-white text-lg overflow-y-auto pb-10">
           ...
           <button onClick={() => { setIsMobileMenuOpen(false); navigate('/PublicServiceBooking'); }} className="text-[#3a9e9e] font-bold text-left hover:text-white transition-colors border-b border-white/10 pb-3">Boka Service</button>
